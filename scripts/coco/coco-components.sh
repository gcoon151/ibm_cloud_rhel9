...
PODVM_BINARY_DEF=registry.redhat.io/openshift-sandboxed-containers/osc-podvm-payload-rhel9:1.10.3
PODVM_BINARY_LOCATION_DEF=/podvm-binaries.tar.gz
PAUSE_BUNDLE_DEF=registry.redhat.io/openshift-sandboxed-containers/osc-podvm-payload-rhel9:1.10.3
