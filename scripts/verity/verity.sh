...
# Note: QCOW2 repair must happen OUTSIDE the container after it exits
# because the image file is locked while the container is running.
# The repair is handled by the build script after the container completes.